...
describe.skip('Start', () => {
  ...
  it('should re-start timer with updated initialTime', () => {
    // Given
    function Component({ initialTime }: { initialTime: number }) {
    ...
    function Component() {
      ...
      return (
        <div>
          ...
          <button type="button" data-testid="pause" onClick={pause}>
            Start
          </button>
          <p data-testid="time">{time}</p>
        </div>
    ...
    function Component() {
      ...
      return (
        <div>
          ...
          <button type="button" data-testid="advanceTime" onClick={() => advanceTime(10)}>
            Advance time
          </button>
          <p data-testid="time">{time}</p>
        </div>
    ...
    function Component() {
      ...
      return (
        <div>
          ...
          <button type="button" data-testid="advanceTime" onClick={() => advanceTime(5)}>
            Advance time
          </button>
          <p data-testid="time">{time}</p>
        </div>
    ...
    function Component() {
      ...
      return (
        <div>
          ...
          <button type="button" data-testid="advanceTime" onClick={() => advanceTime(50)}>
            Advance time
          </button>
          <p data-testid="time">{time}</p>
        </div>
...
describe.skip('State and callbacks', () => {
  ...
  it('should call updated callback function when time is updated', () => {
    ...
    function Component({ onTimeUpdate }: { onTimeUpdate: (time: number) => void }) {
      const { start } = useTimer({
        endTime: 10,
        initialTime: 0,
        onTimeUpdate,
